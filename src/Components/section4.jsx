  ...
  return (
    <div className='w-full lg:min-h-screen h-[70vh] bg-[#FDFAF4] flex justify-center items-center p-2 lg:p-0'>
      <div className='container mx-auto flex flex-col lg:flex-row items-center justify-center relative'>
        <div className='lg:w-1/2 lg:mr-8 relative z-10 lg:border-2 lg:border-yellow-600 p-8 lg:p-16 shadow-lg backdrop-blur-sm bg-white/30 flex flex-col justify-center items-center'>
        ...
        <div className='absolute top-0 right-0 bottom-0 left-0 z-0 lg:w-1/1 mt-10 lg:mt-10 flex justify-center items-center'>
