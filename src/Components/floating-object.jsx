...
const FloatingObject = () => {
  return (
    <div className="flex justify-center items-center h-[15vh] sm:h-[20vh] bg-[#EEF5FF] lg:p-12 p-6">
      <div className="flex flex-row sm:flex-row mb-20 sm:mb-10 p-2 gap-4 lg:flex lg:flex-grow lg:justify-center lg:gap-20 bg-[#1e3758] shadow-xl lg:py-3 py-2 lg:px-20 px-6 z-10 lg:mb-40 rounded-lg items-center">
