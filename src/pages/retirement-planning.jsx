...
const RetirementPlanning = () => {
    return (
        ...
        <Navbar />
          <div className="flex flex-col h-[65vh]">
            <div className="bg-[#284f83] flex-grow flex justify-center items-center w-full">
              <div className="flex flex-col justify-center items-center lg:text-center">
                <h1 className='text-2xl lg:text-3xl text-yellow-600 mb-10'>Retirement Planning</h1>
                <p className='text-2xl mr-2 ml-8 lg:text-5xl'>Transition into retirement with ease.</p>
                <p className='text-lg lg:text-xl mt-10 mb-10 mr-2 ml-4'>Whether retirement is just around the corner or several years away, partnering with a financial advisor can assist you
                <br /> 
          ...
          <h1 className='text-2xl lg:text-5xl mb-3 lg:mb-5 font-bold'>Your retirement, your way.</h1>
