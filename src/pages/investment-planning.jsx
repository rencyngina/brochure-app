...
const RetirementPlanning = () => {
    return (
        ...
        <Navbar />
          <div className="flex flex-col h-[65vh]">
            <div className="bg-[#284f83] flex-grow flex justify-center items-center w-full">
              <div className="flex flex-col justify-center items-center text-center">
                ...
                <p className='text-3xl mr-2 ml-8 lg:text-5xl'>Strategies developed to help you pursue your financial goals.</p>
          ...
          <h1 className='text-2xl lg:text-5xl mb-3 lg:mb-5 font-bold'>Values-based investing made simple.</h1>
