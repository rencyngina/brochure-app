...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50/50">
      <aside className="bg-gradient-to-br from-gray-800 to-gray-900 -translate-x-80 fixed inset-0 z-20 my-4 ml-4 h-[calc(100vh-32px)] w-72 rounded-xl transition-transform duration-300 xl:translate-x-0">
      ...
      {showArticles && (
        <div className="fixed top-0 left-0 w-full  lg:w-full h-full lg:h-full bg-black bg-opacity-75 z-20 flex items-center justify-center overflow-scroll">
        ...
        <div className="fixed top-0 left-0 w-full  lg:w-full h-full lg:h-full bg-black bg-opacity-75 z-20 flex items-center justify-center overflow-scroll">
          <div className="relative z-30">
            ...
            <button
              ...
              className="absolute top-8 right-4 text-white hover:text-gray-300 lg:mb-6 mb-4"
            >
              <IoCloseCircle className="w-8 h-8 text-gray-500" />
            </button>
          </div>
