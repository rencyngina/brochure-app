...
const Risk = () => {
    return (
        ...
        <div className="lg:w-1/2 p-2 lg:p-10 lg:mb-16 lg:mt-6 mb-12 min-16">
            ...
            Risk is an unavoidable reality of life, and if not managed properly, it can have a profound impact on your financial well-being. That’s why risk management is such a critical component of our role as financial advisors.
            </p>
